...
const unfundedGamesText = numUnfundedGames === 1 ? "game" : "games";

// create a new DOM element containing the template string and append it to the description container
const descriptionText = `
    <p>The purpose of our company is to fund independent games. We've been in operation for 12 years.</p>
    <p>A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games.
    Currently, ${numUnfundedGames} ${unfundedGamesText} remain unfunded. We need your help to fund these amazing games!</p>`;
...
topGameNameElement.textContent = `🥇 Top Funded Game: ${topGame.name}`;
firstGameContainer.appendChild(topGameNameElement);

// do the same for the runner up item
const runnerUpGameNameElement = document.createElement("p");
runnerUpGameNameElement.textContent = `🥈 Runner Up: ${runnerUpGame.name}`;
